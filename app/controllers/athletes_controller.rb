class AthletesController < ApplicationController
  ...
  private
    ...
    def athlete_params
      params.require(:athlete).permit(:name, :nationality, :sport, :edition, :number_of_medals, :gold, :silver, :bronze, :number_of_paticipations, :first_participation, :year_of_birth)
    end
end
